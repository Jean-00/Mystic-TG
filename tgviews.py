...
'''
        ...
        logo = f'''{red}
         Unlimited Views Script By Mystic
                              Version = 1
           Made By @KaxuhaUwU
           Owner - @KaxuhaUwU
        '''
        ...
        while True:
            ...
            print(f'''{bgreen} 
        DATA: 
        ➢ Link: https://t.me/{self.channel}/{self.post}
        ➢ View Sent: {self.sucsess_sent}
        ➢ View Failed : {self.failled_sent}

        ERRORS:
        ➢ Proxies Error:  {self.proxy_error}
        ➢ Tokens Error:  {self.token_error}
        ➢ Cookies Error: {self.cookie_error}
            ''')
            sleep(0.3);system('cls' if name=='nt' else 'clear')
...
class Auto:
    def __init__(self):
        ...
        print(f'{cyan} [ WAIT ] Scraping proxies... ')
